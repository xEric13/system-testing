            ...
            <div class="col-md-12">
                ...
                <form method="post" action="{{url('admin/save-alumni')}}">
                    ...
                    <div class="md-3">
                        ...
                        placeholder="Enter Family Name" value="{{old('familyName')}}">
                        @error('familyName')
                    ...
                    <div class="md-3">
                        ...
                        placeholder="Enter Middle Name" value="{{old('maidenName')}}">
                        @error('maidenName')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
                    ...
                    <div class="md-3">
                        ...
                        placeholder="Enter Middle Initial" value="{{old('midlleInitial')}}">
                        @error('middleInitial')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
                    ...
                    <div class="md-3">
                        ...
                        placeholder="Enter Address" value="{{old('presentAddress')}}">
                    ...
                    <div class="md-3">
                        ...
                        placeholder="Enter Year Graduated" value="{{old('yearGraduated')}}">
                        @error('yearGraduated')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
                    ...
                    <div class="md-3">
                        ...
                        placeholder="Enter Awards" value="{{old('awards')}}">
                        @error('awards')
                            <div class="alert alert-danger" role="alert">
                                {{$message}}
                            </div>
